module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    sass: {
      ...
      dev: {
        ...
        files: {
          ...
          "dist/styles/bootstrap.css": "src/styles/bootstrap.scss"
        },
      },
    ...
    postcss: {
      ...
      dev: {
        src: ["dist/styles/main.css", "dist/styles/bootstrap.css"],
      },
      prod: {
        src: ["dist/styles/main.css", "dist/styles/bootstrap.css"],
      },
    ...
    cssmin: {
      prod: {
        files: {
          ...
          "dist/styles/bootstrap.min.css": ["dist/styles/bootstrap.css"]
        },
      },
    },
    ...
    copy: {
      ...
      bootstrap: {
        ...
        src: ["js/bootstrap.bundle.min.js", "js/bootstrap.bundle.min.js.map"],
